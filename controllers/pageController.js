//mail yollaya bilmek icin gereken paket
import nodemailer from "nodemailer";
import Photo from "../models/photoModel.js";
import User from "../models/userModel.js";


//index.js sayfamıza kayıtlı fotoları otomatik getirme islemi eklendi
...
const getIndexPage = async (req,res) => {
  //fotolor kayıt tarihi sırasına gore gosterildi ayrıca en fazla 3 foto gosterildi
...
const sendMail = async (req,res) => {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "gurkanbil@gmail.com",
      pass: "bhfsencoudcwcvcl"
  ...
  // send mail with defined transport object
    await transporter.sendMail({to: "gurkanbil@gmail.com", // list of receivers
